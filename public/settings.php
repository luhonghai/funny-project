        ...
        if ($error == "") {
            ...
            if ($gstop == "0") {
                ...
                if ($error == "") {
                    ...
                    if (file_exists($myvideoimgnew2)) {
                        if (allowAWS()) {
                            aws_upload_images($AWS_IMG_AVATAR."/" . $thepp, $myvideoimgnew2);
                            unlink($myvideoimgnew2);
                        }
            ...
            if ($cstop == "0") {
                ...
                if ($error == "") {
                    ...
                    if (file_exists($myvideoimgnew)) {
                        if (allowAWS()) {
                            aws_upload_images($AWS_IMG_AVATAR."/cover/". $thepp, $myvideoimgnew);
                            unlink($myvideoimgnew);
                        }
