...
<?php
    ...
    //echo $user;
    //$sql_select_post = "Select * from Post";
    $sql_select_post = "SELECT Post.post_id, Post.title, Post.post_date, Post.content, Post.image_url, Post.music_url, Post.category_id, Category.title as category, Post.user_id, Users.email, Users.image, Users.username \n"
            ...
            . "INNER JOIN `Category` ON Post.category_id = Category.category_id ORDER BY Post.post_date DESC";
    $result = mysqli_query($con, $sql_select_post);

    $sql_music = "SELECT title,image_url,song_name,music_url FROM Post ORDER BY post_date DESC LIMIT 5";
        ...
        <div class="content " role="main">
            ...
            <div class="row">
                <div class="col-sm-8" style="margin-top: 35px;">
                    <div class="boxed">
                        <div class="inner">
                            <h3 class="widget-title" style="margin:10px;">All Posts</h3>
                    ...
                    <?php
                        while($row = mysqli_fetch_array($result)){
                            ...
                            echo "<div style='float:right;font-size:11px;margin-top: -10px;'>";
                            echo "Poster: <a href='my_post.php?user_id=".$row['user_id']."'><span>" .$row['username']. "</span></a><br/>";
                            echo "<label style='margin-top:5px;'>".$row['post_date']."</label>";
                            echo "</div>";
                        ...
                        <div class="inner">
                            <div class="tab-content clearfix">
                                <div class="tab-pane clearfix fade in active" id="events">
                                    <div class="tab_image"><img src="uploads/onerepublic.jpg" alt="" /></div>
                                    <div style="float:right;font-size:11px;">
                                         Poster: <a href="#"><span>long.nguyen</span></a><br/>
                                         <span>2014-02-24 @ 14:12</span>
                                    </div>
                                    <h4 style="width:70%;">One Republic</h4>
                                    <p>OneRepublic is an American, self-proclaimed “genreless”, band formed in Colorado Springs in 2002 by Ryan Tedder and Zach Filkins.</p>

                                    <a href="#" class="see-more" style="margin-top: 60px;"><span>More</span></a>
                                    <div class="tagcloud" style="margin-top:60px;float:right;">
                                        <a href="#" class="tag-link-1" title="2 topics" style="margin-bottom: 3px;"><span>Design</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
