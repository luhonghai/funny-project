...
.grid tr.filter                
{
background:#ffcccc;cursor:default
}
.grid tr.filter th
{
...
{
background:#ff6666;padding:2px 10px
}
...
ul.tabs 
{
border-top:1px solid #bebebe;background-color:#ffcccc
}
ul.tabs li 
{
list-style:none
...
ul.tabs,ul.tabs a             
{
background:url(<?php echo $iurl;?>/tabs_link_bg.gif) repeat-y 100% #ffcccc
}
ul.tabs a:hover                
{
...
.switcher 
{
margin-bottom:10px;border:1px solid #cddddd;background:#ff6666;padding:10px
}
.side-col .switcher 
{
...
.box,.entry-edit fieldset,.entry-edit .fieldset
{
 border:1px solid #d6d6d6; background:#ffffcc
}
  .scroll-cont
{
...
.middle
{
    min-height:450px;    background:#ffffff;    padding:23px 27px 0 27px
}
.middle-popup
{
...
.footer
{
    clear:both;    background:url(<?php echo $iurl;?>/footer_bg.gif) repeat-x #ffcccc;    padding:105px 2.8em 2.8em 2.8em;    font-size:.95em;    text-align:center
}
...
.header-right 
{
padding:10px 25px 0 15px;font-size:.95em;color:#000
}
...
.content-header h3 
{
float:left;margin:.3em .5em 0 0;color:#ff0000;font-size:1.25em;line-height:1.2em
}
...
{
 position:fixed; left:0; top:0; display:none; border:0; border-bottom:solid 1px #988753;z-index:100; background:#cccccc; opacity:.85; -moz-opacity:.85; filter:alpha(opacity=85); width:100%
}
...
.login-container                       
{
width:400px;margin:170px auto;text-align:center
}
.login-box                             
{
position:relative
...
.login-form                            
{
padding:27px 57px 35px 57px;;text-align:left; border:1px solid #cccccc;background:#ffcccc
}
.login-form #messages                  
{
margin:0 8px 0 0
...
.login-box .bottom 
{
    width:400px;    height:5px;    background:url(<?php echo $iurl;?>/login_box_bottom.jpg) no-repeat;    overflow:hidden
}
.login-container .legal
{
    margin:0;    background:url(<?php echo $iurl;?>/login_box_legal_bg.gif) no-repeat; padding:8px 8px 5px 8px; font-size:.95em;color:#ffff00
}
...
.dashboard-container 
{
border:1px solid #ccc; background:#cccccc
}
...
{
margin:0px 0px 10px 0px;padding:8px 15px;background:#ffcccc
}
.order-save-in-address-book 
{
margin:0px 0px 0px 0px;padding:8px 15px;background:#ffcccc
}
...
{
border:1px solid #cddddd;padding:1em; background:#ffcccc;margin:1.5em 0
}
.custom-options .option-header
{
border:0;width:100%;background:#ffcccc;border-bottom:1em solid #ffcccc
}
