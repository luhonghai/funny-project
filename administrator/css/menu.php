...
.nav-bar
{
    border-top:1px solid #2d444f;    border-bottom:1px solid #2d444f;    background:#ff6666; padding:0 30px
}
#nav
{
float:left
...
#nav li.active
{
    margin-left:-1px;    background:#000000;    color:#fff;    font-weight:bold
}
#nav li.active em
{
...
#nav a
{
 float:left; padding:0 14px; color:#ffff00; line-height:27px
}
#nav li.over a
{
color:#ffff99
