    ...
    <div id="content-holder">
		...
		<div class="main-filter ">
            <ul class="content-type">
                ...
                <li> <a class="current" href="{$baseurl}/topusers?t=nam"><strong>Năm</strong></a></li>
...
{include file='top-list.tpl'}
          <div id="paging-buttons" class="paging-buttons">
            	{if $tpp ne ""}
                <a href="{$baseurl}/topusers?t=nam&page={$tpp}" class="previous">&laquo; {$lang166}</a>
                {else}
                <a href="#" onclick="return false;" class="previous disabled">&laquo; {$lang166}</a>
                {/if}
                {if $tnp ne ""}
                <a href="{$baseurl}/topusers?t=nam&page={$tnp}" class="older">{$lang167} &raquo;</a>
                {else}
