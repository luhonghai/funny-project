	    	    	    		...
	    	    	    		<tbody>
                                    ...
                                    <tr id="" >
                                        ...
                                        <td class=" last">
                                            ...
                                            <a href="stories_reported.php?page={$currentpage}&sortby={$sortby}&sorthow={$sorthow}{if $search eq "1"}&fromid={$fromid}&toid={$toid}&story={$story}&active={$active}{/if}&delete=1&PID={$results[i].PID}">Delete Gag</a>&nbsp;|&nbsp;
