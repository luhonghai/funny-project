            ...
            <div id="page:main-container">
				<div class="columns ">
                                ...
                                <div id="isoft_group_1_content" style="display:none;">
                                	<div class="entry-edit">
                                        <div class="entry-edit-head">
                                            <h4 class="icon-head head-edit-form fieldset-legend">Channels</h4>
        			...
        			<div id="customerGrid">
        				...
        				<tr>
                    		<td class="pager">
                            	Showing {if $total gt 0}{$beginning} - {$ending} of {/if}{$total} Channels
                    		</td>
                			<td class="export a-right"></td>
            				<td class="filter-actions a-right">
                            	<button  id="id_ffba3971e132ae3d78c160244ea09b39" type="button" class="scalable " onclick="document.location.href='ch_manage.php'" style=""><span>Reset Filter</span></button>
							...
							<div class="hor-scroll">
	    	    	    		...
	    	    	    		<tbody>
                                    ...
                                    <tr id="" >
                                        ...
                                        <td class=" last">
                                        	<a href="ch_edit.php?CID={$results[i].CID}">Edit</a>&nbsp;|&nbsp;
                                            <a href="ch_manage.php?page={$currentpage}&sortby={$sortby}&sorthow={$sorthow}{if $search eq "1"}&fromid={$fromid}&toid={$toid}&cname={$cname}&active={$active}{/if}&delete=1&CID={$results[i].CID}">Delete</a>
                                        </td>
                                	</tr>
                                    {/section}
                                    <tr>
					...
					<div class="main-col" id="content">
						<div class="main-col-inner">
                            ...
                            <div class="content-header">
                               <h3 class="icon-head head-products">Channels - Channels</h3>
                               <p class="content-buttons form-buttons">
                                    <button  id="id_be616be1324d8ae4516f276d17d34b9c" type="button" class="scalable add" onclick="document.location.href='ch_create.php'" style=""><span>Create Channel</span></button>			
                               </p>
                            </div>
